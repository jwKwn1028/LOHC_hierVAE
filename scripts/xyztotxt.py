...
def xyz_to_smiles_txt(input_path: str, output_txt: str) -> None:
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
        print("Usage: python xyz2smiles.py <xyz_file_or_dir> <output_txt>")
        sys.exit(1)
    xyz_to_smiles_txt(sys.argv[1], sys.argv[2])